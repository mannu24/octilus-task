        ...
        <div class="row">
            ...
            <div class="offset-lg-2 col-lg-8 offset-md-1 col-md-10 col-12 text-center">
                <div class="formpart">
                    ...
                    <div v-if="slide_counter == 1">
                        <h3>Enter Your Personal Details</h3>
                        <div class="mb-3 text-start">
                            <label for="FormControlInput1" class="form-label">First Name</label>
                            <input type="text" v-model="form.first_name" class="form-control" id="FormControlInput1" placeholder="First Name">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <input type="text" v-model="form.last_name" class="form-control" id="FormControlInput2" placeholder="Last Name">
                        ...
                        <div class="mb-3 text-start">
                            ...
                            <fieldset>
                                ...
                                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 ">
                                    <select name="lstDobDay" id="lstDobDay" v-model="form.dob_day" class="form-control watermark">
                                   ...
                                   <span class="text-danger" v-if="errors.dob_day">{{errors.dob_day[0]}}</span>
                                </div>
                                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12 ">
                                    <select name="lstDobMonth" id="lstDobMonth" v-model="form.dob_month" class="form-control watermark">
                                   ...
                                   <span class="text-danger" v-if="errors.dob_month">{{errors.dob_month[0]}}</span>
                                </div>
                                <div class="form-group col-lg-4 col-md-4 col-sm-4 col-12">
                                    <select name="lstDobYear" v-model="form.dob_year" id="lstDobYear" class="form-control">
                                    ...
                                    <span class="text-danger" v-if="errors.dob_year">{{errors.dob_year[0]}}</span>
                                </div>
                        ...
                        <div class="mb-3 text-center">
                            <button type="button" class="btn btn-warning next01" @click="slide_counter = 2">Next</button>
                        </div>
                    </div>
                    <div v-if="slide_counter == 2">
                        <h3>Enter Your Contact Details</h3>
                        <div class="mb-3 text-start">
                            <label for="FormControlInput4" class="form-label">Email Address</label>
                            <input type="email" v-model="form.email" class="form-control" id="FormControlInput4" placeholder="Email Address">
                            <span class="text-danger" v-if="errors.email">{{errors.email[0]}}</span>
                        </div>
                        <div class="mb-3 text-start">
                            <label for="FormControlInput5" class="form-label">Phone Number</label>
                            <input type="text" v-model="form.phone" class="form-control" id="FormControlInput5" placeholder="Phone Number">
                            <span class="text-danger" v-if="errors.phone">{{errors.phone[0]}}</span>
                        </div>
                        <div class="mb-3 text-center d-flex justify-content-around">
                            <button type="button" class="btn btn-success" id="" @click="slide_counter = 1">Back</button>
